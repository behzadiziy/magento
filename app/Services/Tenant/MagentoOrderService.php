...
class MagentoOrderService
{
    ...
    public function getOrdersForStore(int $storeId): array
    {
        ...
        $endpoint = "{$this->apiUrl}/rest/V1/orders?" . http_build_query($searchCriteria);
    ...
    {
        $token = $this->getAccessToken();
        $endpoint = "{$this->apiUrl}/rest/V1/orders/{$orderId}";
    ...
    {
        $token = $this->getAccessToken();
        $endpoint = "{$this->apiUrl}/rest/V1/store/storeViews";
